...
const ContactInfoSection = ({
  ...
  return (
    <div
      className={`lg:w-[60%] absolute md:relative md:flex flex-col gap-4 w-full min-w-0 2xl:max-w-[36vw] ml-auto bottom-0 left-0 md:left-auto p-4 md:p-0 transition-all duration-500 ease-in-out overflow-hidden 2xl:max-h-none ${
        isInfoCollapsed
    ...
    >
      <div className="lg:flex-1 md:flex lg:items-end w-full min-w-0">
        <div className="w-full rounded-xl overflow-hidden relative border border-[#dcdcdc] p-1 flex items-end h-[40vh] md:h-[30vh] xl:h-[30vh]">
          ...
          />
          <div className="z-20 text-white relative border border-white py-1 px-4 rounded-lg bg-black/10 backdrop-blur-[5px] flex-1 text-xs flex flex-col lg:flex-row lg:justify-between lg:items-center gap-2">
            <div>
      ...
      <div className="flex justify-between pt-4 border-t border-white mt-4 lg:mt-0 flex-col lg:flex-row text-xs">
